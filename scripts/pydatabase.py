...
This is a set of programs for managing the Pantheon database.
These functions make it easy to define data sets, specify which data to use,
define group analyses, and automate the analysis procedures.
...
def get_datanames_by_person(DBname, dbnumlist, prefix, mode = 'dict', separate_conditions = True):
    ...
    for nn, dbnum in enumerate(dbnumlist):
        ...
        # print('dbnum = {}'.format(dbnum))
        # print('dbhome = {}'.format(dbhome))
