...
This is a set of programs for displaying fMRI results in various forms.
...
def draw_sem_plot(results_file, sheetname, rownumbers, drawregionsfile, statname, scalefactor, thresholdtext = 'abs>0', writefigure = False):
    ...
    for nn in rownumbers:
        ...
        if statcondition:
            ...
            an1 = ax.annotate('',xy=endpoint,xytext = startpoint, arrowprops=dict(arrowstyle="->", connectionstyle='arc3', linewidth = linethick, color = linecolor, shrinkA = 0.01, shrinkB = 0.01))
            acount+= 1
            an_list.append(an1)
