"""
py2ndlevelanalysis.py

This is a set of programs for 2nd-level analysis of BOLD responses and SEM results, in
 relation to participant characteristics, and for group comparisons etc.
